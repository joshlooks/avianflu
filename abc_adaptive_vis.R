...
require(latex2exp)
library(KScorrect)
post_tibble <- read_csv('log_adaptive_4.csv')
...
ggsave("Plots/Param_posterior_prior_adaptive.pdf",plot = post_density_prior, width = 40,  height = 40,  units = "cm")
ggsave("Plots/Param_posterior_adaptive.pdf",plot = post_density, width = 40,  height = 40,  units = "cm")
