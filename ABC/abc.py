import numpy as np
from scipy.stats import loguniform, multivariate_normal, norm
from numpy.random import choice, normal
from copy import copy

def abc(dist_fun, N_part = 1000, N_gen = 7, tol = [1e17,1e17,1e17,1e17,1.5e16,1.4e16,1.32e16], std = [1e-9,1e-9,1e-2,1e-2,1e-5,5e-3,5e-3]):
    # NB: HYPERPARAMETERS:
