...
transitions = list(c(Tu = -1, Eu = +1), c(Eu = -1, Iu = +1), c(Iu = -1, Du = +1), c(Du = -1, Tu = +1),
                   ...
                   c(Vu = +1), c(Vu = -1), c(Vu = -1), c(Vu = -1, Vl = +1), c(Vu = +1, Vl = -1),
                   c(Vl = +1), c(Vl = -1), c(Vl = -1), c(Vl = -1),
                   c(Fa = +1), c(Fa = -1),
                   c(X = +1), c(X = -1))
...
lvrates <- function(x, para, t){
  return(c(para$b_u*x['Tu']*x['Vu'], para$g*x['Eu'], para$d*x['Iu'], para$lambda_u*x['Du'], 
           ...
           para$p*x['Iu'], para$c*x['Vu'], para$gamma*para$b_u*x['Tu']*x['Vu'], para$t_1*x['Vu'], para$t_2*x['Vl'],
           para$p*x['Il']/(1+para$kappa*x['Fa']), para$c*x['Vl'], para$gamma*para$b_l*x['Tl']*x['Vl'], para$k*x['Vl']*x['X'],
