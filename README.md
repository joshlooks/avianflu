...
`article_plotting_final.ipynb`,`article_plotting_shift.ipynb`, `abc_final_vis.R`, `model_sim.py` and `article_plotting_mort_final.ipynb` contain more plotting code used to create figures in the publication (all figures can be found in the `Plots` directory).
