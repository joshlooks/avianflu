...
require(latex2exp)
library(KScorrect)
post_tibble <- read_csv('log_adaptive_6.csv')
...
ggsave("Plots/Param_logposterior_added.pdf",plot = log_post_density, width = 40,  height = 40,  units = "cm")
...
ggsave("Plots/Param_logposterior_added.pdf",plot = p, width = 40,  height = 40,  units = "cm")
